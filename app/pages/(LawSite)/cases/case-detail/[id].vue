  ...
  <div class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
      ...
      <div v-if="caseDetail" class="flex items-center gap-3">
        <button
          v-if="canAssignLawyer"
          @click="showAssignLawyerDialog = true"
        ...
        <button
          @click="navigateTo(`/cases/edit/${caseId}`)"
      ...
      <div class="bg-white rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div v-if="caseDetail.client" class="pt-4 border-t border-gray-200">
          <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
            <img 
              v-if="caseDetail.client.verification.passport_size_photo"
              :src="caseDetail.client.verification.passport_size_photo.url" 
              alt="Client photo"
              class="w-12 h-12 rounded-full object-cover"
            />
            <div class="flex-1">
              <p class="text-sm text-gray-600">Linked to registered client</p>
              <p class="font-medium text-gray-900">{{ caseDetail.client.verification.full_name }}</p>
